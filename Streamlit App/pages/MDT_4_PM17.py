...
pm17_toilet = pd.read_excel(os.path.join(data_dir, "Final_PM17-Toilet.xlsx"))
pm17_towel = pd.read_excel(os.path.join(data_dir, "Final_PM17-Towel.xlsx"))
pm17_facial = pd.read_excel(os.path.join(data_dir, "Final_PM17-Facial.xlsx"))
...
feature_config_toilet = {
    ...
    'Mean_Load KWH Tickling Refiner': {
        'min': float(pm17_toilet['Mean_Load KWH Tickling Refiner'].min()),
        'max': float(pm17_toilet['Mean_Load KWH Tickling Refiner'].max()),
        'default': 0,
        'step': 1,
        'format': "%.2f"},
    'Mean_Creping': {
...
feature_config_towel = {
    ...
    'Mean_Load KWH Tickling Refiner': {
        'min': float(pm17_towel['Mean_Load KWH Tickling Refiner'].min()),
        'max': float(pm17_towel['Mean_Load KWH Tickling Refiner'].max()),
        'default': 0,
        'step': 1,
        'format': "%.2f"},
    'Mean_Creping': {
...
feature_config_facial = {
    ...
    'Mean_Load KWH Tickling Refiner': {
        'min': float(pm17_facial['Mean_Load KWH Tickling Refiner'].min()),
        'max': float(pm17_facial['Mean_Load KWH Tickling Refiner'].max()),
        'default': 0,
        'step': 1,
        'format': "%.2f"},
    'Mean_Creping': {
